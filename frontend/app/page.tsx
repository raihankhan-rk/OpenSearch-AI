  ...
  return (
    <main className="w-screen h-screen bg-gradient-to-br from-[#1a1a1a] to-black">
      ...
      <div className="w-screen h-screen flex flex-col items-center justify-center">
        <h1 className=" text-5xl font-bold text-white max-md:text-3xl "> OpenSearch AI </h1>
        <h1 className=" text-xl text-gray-500 mt-5 max-md:text-sm text-center max-md:px-10"> OpenSearch is a powerful personalized AI search engine </h1>
